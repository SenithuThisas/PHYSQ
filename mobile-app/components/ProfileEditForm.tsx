...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, ScrollView, Alert, ActivityIndicator, Image, Modal, KeyboardAvoidingView, Platform } from 'react-native';
...
export default function ProfileEditForm({ onBack }: ProfileEditFormProps) {
